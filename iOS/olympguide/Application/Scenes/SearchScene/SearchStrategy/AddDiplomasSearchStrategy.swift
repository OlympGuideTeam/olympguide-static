//
//  AddDiplomasSearchStrategy.swift
//  olympguide
//
//  Created by Vladislav Pankratov on 24.04.2025.
//

import UIKit

struct AddDiplomasSearchStrategy: SearchStrategy {
    ...
    func build(with model: ModelType) -> (UIViewController?, PresentMethod?) {
        (AddDiplomaAssembly.build(with: model), .push)
    }
